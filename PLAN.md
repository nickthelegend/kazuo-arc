...
- 2026-09-13 16:25 IST — **Still blocked on the user, unchanged:** `KAZUO_OPERATOR_KEY` on Railway (+ redeploy, then point both Vercel projects back at Railway — production currently depends on this machine's tunnel); `KAZUO_DEMO_PAYER_KEY` on Vercel (unblocks A9/A18/A19 in the browser); a World App Selfie Check scan (W3–W6); a Privy email login (A12/A13).
